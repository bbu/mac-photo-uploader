#import "DeleteChromaKeyRollService.h"

@interface DeleteChromaKeyRollService () <NSURLConnectionDelegate, NSXMLParserDelegate> {
    ServiceResult *result;
}
@end

@implementation DeleteChromaKeyRollService

- (NSString *)serviceURL
{
    return kCandidEventServiceRoot @"deleteChromaKeyRoll";
}
